! function (e, i) {
    "function" == typeof define && define.amd ? define(["jquery"], i) : "object" == typeof exports ? module.exports = i(require("jquery")) : e.dropify1 = i(e.jQuery)
}(this, function (e) {
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: {
                    "default": "DRAG AND DROP PROOF IMAGE HERE",
                ...
                tpl: {
                    wrap: '<div class="dropify1-wrapper"></div>',
                    loader: '<div class="dropify1-loader"></div>',
                    message: '<div class="dropify1-message"><span class="file-icon" /> <p>{{ default }}</p></div>',
                    preview: '<div class="dropify1-preview"><span class="dropify1-render"></span><div class="dropify1-infos"><div class="dropify1-infos-inner"><p class="dropify1-infos-message">{{ replace }}</p></div></div></div>',
                    filename: '<p class="dropify1-filename"><span class="file-icon"></span> <span class="dropify1-filename-inner"></span></p>',
                    clearButton: '<button type="button" class="dropify1-clear">{{ remove }}</button>',
                    errorLine: '<p class="dropify1-error">{{ error }}</p>',
                    errorsContainer: '<div class="dropify1-errors-container"><ul></ul></div>'
                }
            };
            this.element = i, this.input = e(this.element), this.wrapper = null, this.preview = null, this.filenameWrapper = null, this.settings = e.extend(!0, s, t, this.input.data()), this.errorsEvent = e.Event("dropify1.errors"), this.isDisabled = !1, this.isInit = !1, this.file = {
                object: null,
                name: null,
                size: null,
                width: null,
    ...
    return i.prototype.onChange = function () {
        ...
        if (i.files && i.files[0]) {
            var t = new FileReader,
                ...
                n = null,
                o = this,
                h = e.Event("dropify1.fileReady");
            this.clearErrors(), this.showLoader(), this.setFileInformations(r), this.errorsEvent.errors = [], this.checkFileSize(), this.isFileExtensionAllowed(), this.isImage() && this.file.size < this.sizeToByte(this.settings.maxFileSizePreview) ? (this.input.on("dropify1.fileReady", this.onFileReady), t.readAsDataURL(r), t.onload = function (e) {
        ...
        if (this.input.off("dropify1.fileReady", this.onFileReady), 0 === this.errorsEvent.errors.length) this.setPreview(i, t);
        else {
        ...
        this.wrapper.removeClass("has-error").addClass("has-preview"), this.filenameWrapper.children(".dropify1-filename-inner").html(this.file.name);
        var s = this.preview.children(".dropify1-render");
        if (this.hideLoader(), i === !0) {
            var r = e("<img />").attr("src", t);
            this.settings.height && r.css("max-height", this.settings.height), r.appendTo(s)
        } else e("<i />").attr("class", "dropify1-font-file").appendTo(s), e('<span class="dropify1-extension" />').html(this.getFileType()).appendTo(s);
        this.preview.fadeIn()
    }, i.prototype.resetPreview = function () {
        this.wrapper.removeClass("has-preview");
        var e = this.preview.children(".dropify1-render");
        e.find(".dropify1-extension").remove(), e.find("i").remove(), e.find("img").remove(), this.preview.hide(), this.hideLoader()
        ...
        if (0 === this.errorsEvent.errors.length) {
            var i = e.Event("dropify1.beforeClear");
            this.input.trigger(i, [this]), i.result !== !1 && (this.resetFile(), this.input.val(""), this.resetPreview(), this.input.trigger(e.Event("dropify1.afterClear"), [this]))
        ...
        var t = e.Event("dropify1.error." + i);
